...
setup(name='ofxstatement-be-kbc-credit',
      version=version,
      author="Pieter Lenaerts",
      author_email="pieter.aj.lenaerts@gmail.com",
      url="https://github.com/plenaerts/ofxstatement-be-kbc-credit",
      ...
      entry_points={
          'ofxstatement':
          ['kbcbecredit = ofxstatement.plugins.kbcbecredit:KbcBeCreditPlugin']
          },
